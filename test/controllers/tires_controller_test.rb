...
class TiresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tire" do
    assert_difference('Tire.count') do
      post tires_url, params: { tire: { marca: @tire.marca, owner: @tire.owner, rin: @tire.rin } }
    end
  ...
  test "should update tire" do
    patch tire_url(@tire), params: { tire: { marca: @tire.marca, owner: @tire.owner, rin: @tire.rin } }
